	...
	<body style="background:url(${ctx }/common/images/sign_bdbg.png); min-width:1220px;">
		<div class="sign_in stand">
			<div class="sign_in_bg">
				<div class="login_logo"><img src="${ctx }/common/images/yn/login_logo.png"/></div>
				<div class="sign_title"><img src="${ctx }/common/images/yn/sign_title.png"/></div>
				...
				<div class="sign_in_small_small">
		            ...
		            <div class="wx-login-div">
					    <div class="qrcode-img">
					    	<img src="${ctx }/common/images/yn/qrcodeyn.png"/>
					    </div>
					    <p><i></i>扫一扫下载手机客户端</p>
					</div>
