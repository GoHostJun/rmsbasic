...
var newsCuesId="<%=request.getParameter("_id")%>";
var newsCuesType="<%=request.getParameter("type")%>";
var newsCuesSubbmit="<%=request.getParameter("subbmit")%>";
var newsCuesLoginid="<%=request.getParameter("loginid")%>";
var newsCuesNikename="<%=request.getParameter("nikename")%>";
