...
<script type="text/javascript" src="${ctx }/js/organize/materialtemplate.js"></script>
</head>
	...
	<div class="gg_div js_list" style="margin-top: 0px;">
		...
		<div  class="gg_cont">
			...
			<div class="btn_div fr">
				<a href="javascript:showMaterialTemplateList(1,10);" class="chaxun">查询</a> <a id="ele6" href="javascript:openAddMaterialTemplate();" class="new_btn">新增</a> 
			</div>
			<div class="clear"></div>
