...
<script type="text/javascript" src="${ctx }/js/docs/docs_add.js"></script>
...
<body>
	...
	<input type="hidden" id="addUpload" value=0>
		<p class="p_url">
			<i></i><a href="javascript:toHome();">首页</a> > <a href="javascript:uCont('material/toDocs/');">文稿</a> > <a href="javascript:;">新建文稿</a>
		</p>
				...
				<div class="check_div">
					<div class="check_left fl">
					    <div class="wengao_edit_div">
					                    ...
					                    <div class="extended-drop">
					                        ...
					                        <div class="input_div">
					                            ...
					                            <select name="titleType" id="titleType">
					                                ...
					                                <option value="1">口播</option>
					                                <option value="2">片头</option>
					                            </select>
					                        </div>
					                        <div class="input_div">
					                            <p>题花</p>
					            ...
					            <div class="big_input_div wg-input-bg">
					               ...
					               <div class="clear"></div>
					                <div class="controls" style="">
									    ...
									    <input type="hidden" id="docsContent" name="noticeContent" /> 
					        ...
					        <div class="edit_btn_div" id="saveandendit">
					            ...
					            <a href="javascript:;" class="empty_btn" id="rest_buttom">重置</a>
					            <div class="clear"></div>
					        </div>
					    </div>
					</div>
					<div class="check_right fr">
						<div class="video_div">
							...
							<div id="player">
								<img src="${ctx }/common/images/material_not_pic3.jpg" width="100%">
							</div>				
							</div>
						</div>
