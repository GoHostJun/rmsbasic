...
<script type="text/javascript" src="${ctx }/js/material/material_list.js"></script>
...
<div class="search_div">
    ...
    <a style="cursor:pointer" onclick="getListData(1,10)"><i></i>搜索</a>
    <div class="clear"></div>
</div>
<p class="p_url material_url"><i></i><a href="javascript:toHome();">首页</a> > <a href="javascript:uCont('material/toMaterial/');">素材</a></p>
<p class="material_choice">
	类型：<span onclick="getListDataByMaterialType(this);" class="active">全部</span><span onclick="getListDataByMaterialType(this);">视频</span><span onclick="getListDataByMaterialType(this);">音频</span><span onclick="getListDataByMaterialType(this);">图片</span>
</p>
...
<div class="list_cont">
	<div class="inner" id="outter">
    	<p class="check_p">
            ...
            <a onclick="deleteMaterial();" style="cursor:pointer;"><i class="del_img"></i>删除</a>
            <a href="#" onclick="toFastCode();"><i class="kb_img"></i>快编</a>
            <div class="clear"></div>
        </p>
		<div id="listDiv"></div>   
		<div id="pageDiv"></div>      
