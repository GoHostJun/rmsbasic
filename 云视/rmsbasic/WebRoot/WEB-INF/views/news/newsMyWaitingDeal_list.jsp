...
<script src="${ctx }/js/news/newsMyWaitingDeal_list.js"></script>
<title>云报道</title>
...
<p class="material_choice">
	类型：<span onclick="uCont('news/toNewsMyWaitingDealList/');" class="active">待审核</span><span onclick="uCont('news/toNewsMyWaitingSendList/');">待推送</span><span onclick="uCont('news/toNewsCompleteList/');">已完成</span>
</p>
<div class="list_cont">
	<div class="inner" id="outter">
    	<p class="check_p">
            ...
            <a href="javascript:;"  id="readDeal"><i class="kb_img"></i>标记已读</a>
            <div class="clear"></div>
        </p>
        <div id="inner_list">
