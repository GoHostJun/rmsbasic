...
<title>角色管理</title>
<script type="text/javascript" src="${ctx }/js/organize/area.js"></script>
</head>
	...
	<div class="gg_div js_list">
		...
		<div class="gg_cont">
			...
			<div class="btn_div fr">
				<a href="javascript:showAreaList(1,10);" class="chaxun">查询</a> <a href="javascript:areaAddOpen();" class="new_btn">新增</a> 
			</div>
			<div class="clear"></div>
