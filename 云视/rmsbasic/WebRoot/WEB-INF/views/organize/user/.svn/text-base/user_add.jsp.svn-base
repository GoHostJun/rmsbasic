...
<body>
	<table class="new-user-table">
		...
		<tr>
			...
			<td><input type="hidden" id="txtDepartments" name="txtDepartments"> <input type="text" id="txtDepartmentsName"
				...
				<div id="menuContent" class="menuContent" style="display: none;">
					<ul id="treeDemo" class="ztree" style="margin-top:0; width:263px;"></ul>
				</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><a href="javascript:addUserToAppCode();" class="save-btn"> 保 存 </a>&nbsp;<a href="javascript:layer.closeAll();" class="cancel-btn"> 取 消 </a></td>
		</tr>
	</table>
</body>
</html>
