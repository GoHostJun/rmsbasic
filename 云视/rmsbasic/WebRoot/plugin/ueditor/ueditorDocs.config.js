...
(function() {
	 ...
	 */
	window.UEDITOR_HOME_URL=ctx2+"/plugin/ueditor/"
	var URL = window.UEDITOR_HOME_URL ;

	var ctx = window.UEDITOR_HOME_URL || getUEBasePath();
	var paths = ctx +pathValue.substring(1) ;
	...
	window.UEDITOR_CONFIG = {
		...
		// 服务器统一请求接口路径
	//	serverUrl : paths + "notice/uploadNoticePicture/",
		imageActionName : "1",
		...
		toolbars : [ [ 'fullscreen', 'source', '|', 'undo', 'redo', '|', 'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat',
				'formatmatch',
				// 'autotypeset',
				'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|', 'rowspacingtop',
				...
				'map',
				// 'gmap', 'insertframe', 'insertcode', 'webapp','pagebreak',
				// 'template', 'background',
				...
				// 'print',
				'preview', 'searchreplace','contentbody', 'contentinstruction', 'contentafterwords', 'contentsubtitle'
				,'contentactualsound', 'contentsplitmark'
		// , 'help', 'drafts'
		] ]
	// 当鼠标放在工具栏上时显示的tooltip提示,留空支持自动多语言配置，否则以配置值为准
	 ,labelMap:{
		'contentbody':'添加【正文】',
        'contentinstruction':'添加【导语】',
        'contentafterwords':'添加【编后】',
        'contentsubtitle':'添加【字幕】',
        'contentactualsound':'添加【同期】',
        'contentsplitmark':'添加【分标】'
	 }
