...
@Repository
public class MediaDaoImpl extends BasicDao implements IMediaDao {

	@Override
	public String insertMedia(Map<String, Object> map) {
		return super.insert(Media.MATERIAL,map);
	}

	@Override
	public Map<String, Object> queryOne(String id) {
		return super.findOne(Media.MATERIAL, id);
	}

	@Override
	public List<Map<String, Object>> query(Map<String, Object> sortFilter,Map<String, Object> whereMap,int currentPage,int pageNum) {
		return super.find(Media.MATERIAL,sortFilter, whereMap, currentPage, pageNum);
	}
	...
	public List<Map<String, Object>> query(Map<String, Object> sortFilter,Map<String, Object> whereMap,Map<String, Object> backMap,int currentPage,int pageNum) {
		return super.find(Media.MATERIAL,sortFilter, whereMap, backMap, currentPage, pageNum);
	}

	@Override
	public long updateBySet(Map<String, Object> whereMap, Map<String, Object> set) {
		return super.updateManyBySet(Media.MATERIAL, whereMap, set);
	}
	@Override
	public long update(Map<String, Object> whereMap, Map<String, Object> set) {
		return super.updateMany(Media.MATERIAL, whereMap, set);
	}
	...
	public long updateOne(String id, Map<String, Object> set,boolean option) {
		...
		db.put("$set", set);
		return super.updateOne(Media.MATERIAL, filter, db,option);
	}

	@Override
	public long count(Map<String, Object> set) {
		return super.count(Media.MATERIAL, set);
	}

	@Override
	public long delete(Map<String, Object> whereMap) {
		return super.deleteMany(Media.MATERIAL, whereMap);
	}

	@Override
	public List<Map<String, Object>> query(Map<String, Object> whereMap) {
		return super.find(Media.MATERIAL, whereMap, 1, 100);
	}

	@Override
	public Map<String, Object> queryOne(Map<String, Object> filter) {
		return super.findOne(Media.MATERIAL, filter);
	}
